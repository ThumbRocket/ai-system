...
int main(int argc, char const *argv[])
{
	...
	k=256;
	n=256;
	printf("matrix multiplication for %d x %d x %d\n", m,n,k);

    // Part 2. Allocate memory in host DRAM, h_cc is used to store the CPU result
    ...
    // Part 3. Allocate memory space on the device (GPU)
